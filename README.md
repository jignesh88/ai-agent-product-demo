...
This project uses the Cline Memory Bank methodology for structured documentation. The following sections provide a comprehensive overview of the project's requirements, architecture, and implementation details.
...
Refer to the memory bank sections above for detailed information about the project architecture and implementation. Follow the setup instructions in each component directory to deploy the application.
